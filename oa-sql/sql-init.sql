...
-- ----------------------------
-- Table structure for oa_ledger_zhidi
-- ----------------------------
DROP TABLE IF EXISTS `oa_ledger_zhidi`;
CREATE TABLE `oa_ledger_zhidi` (
...
-- ----------------------------
-- Records of oa_ledger_zhidi
-- ----------------------------

-- ----------------------------
-- Table structure for oa_ledger_zhiye
-- ----------------------------
DROP TABLE IF EXISTS `oa_ledger_zhiye`;
CREATE TABLE `oa_ledger_zhiye` (
  `id` bigint(20) NOT NULL,
  `serial_number` varchar(20) NOT NULL COMMENT '序号',
  `area` varchar(32) NOT NULL COMMENT '片区',
