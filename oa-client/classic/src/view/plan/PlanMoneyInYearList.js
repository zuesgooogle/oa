Ext.define('oa.view.plan.PlanMoneyInYearList', {
    extend: 'Ext.grid.Panel',
    xtype: 'planMoneyInYearList',

    id: 'planMoneyInYearList',
    alias: 'planMoneyInYearList',
    ...
    tbar: [
        {
            ...
            handler: 'addPlanMoneyInYear'
        }, {
            itemId: 'update',
            text: '修改',
            iconCls: 'x-fa fa-edit',
            disabled: true,
            handler: 'viewPlanMoneyInYear'
        }, {
            itemId: 'delete',
            text: '删除',
            iconCls: 'x-fa fa-remove',
            disabled: true,
            handler: 'deletePlanMoneyInYear'
        }],

    store: {
        type: 'planMoneyInYear'
    },
    ...
    listeners: {
        ...
        itemdblclick: 'viewPlanMoneyInYear'
    }
