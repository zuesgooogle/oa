Ext.define('oa.view.plan.PlanChargeYearList', {
    extend: 'Ext.grid.Panel',
    xtype: 'planChargeYearList',

    id: 'planChargeYearList',
    alias: 'planChargeYearList',
    ...
    tbar: [
        {
            ...
            handler: 'addPlanChargeYear'
        }, {
            itemId: 'update',
            text: '修改',
            iconCls: 'x-fa fa-edit',
            disabled: true,
            handler: 'viewPlanChargeYear'
        }, {
            itemId: 'delete',
            text: '删除',
            iconCls: 'x-fa fa-remove',
            disabled: true,
            handler: 'deletePlanChargeYear'
        }],
    ...
    listeners: {
        ...
        itemdblclick: 'viewPlanChargeYear'
    }
